...
<html lang="en">
  <head>
    ...
    <title>MMI | Daftar Project</title>
...
$result = mysqli_query($db,$sql);
			...
			<ul class="breadcrumb">
				...
				<li>
                                    <?php
                            $j=mysqli_query($db,"SELECT * FROM client where id='$_GET[id]'");
                            while($k=mysqli_fetch_array($j)){?> 
                                    <a href="javascript:if(confirm('Lihat Aktifitas?'))
{document.location='detail_client.php?id=<?php echo $k['id']; ?>';}">
...
{document.location='tambahproject.php?id=<?php echo $_GET['id']; ?>';}">Tambah Project</a></center><br><br>
			<br>
